...
?>
	...
	<?php if ( ASTA_USER::asta_current_user_in_roles_list( is_user_logged_in(), array( 'approved', 'administrator' ) ) ) : ?>
	<div class="wpr-admin-menu">
		...
		<div class="options">
			...
			<a href="/profile/#seller" class="my-profile option"><?php echo __( 'Become a seller', 'asta-child' ); ?></a>
			<hr />
			<?php endif; ?>
