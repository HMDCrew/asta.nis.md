...
// implementare le subscription
// var_dump( $details );
?>

<div class="item-container" order_id="<?php echo $args['ID']; ?>">
	<div class="order-item">

		<div class="order-title">

			<h2 class="entry-title">
				<a href="<?php echo WPR_THEME_ORDERS::get_meta( $args['ID'], 'oreder_link' ); ?>" rel="bookmark"><?php echo explode( ', ', $args['post_title'] )[0]; ?></a>
			</h2>

			<sub><?php echo get_the_date( 'd/m/Y', $args['ID'] ); ?></sub>
		</div>
		...
		<div class="price-info">
			...
			<span><?php echo $details['amount'] / 100; ?></span>
		</div>

		<?php if ( 'paid' !== $payment_status ) : ?>
			<button type="button" class="btn btn-primary pay-now-order"><?php echo __( 'Pay now', 'asta-child' ); ?></button>
		<?php endif; ?>
	</div>

	<?php if ( 'paid' !== $payment_status ) : ?>
		<form class="payment-form d-none">
			<div class="payment-element"></div> <!-- Elements will create input elements here -->
