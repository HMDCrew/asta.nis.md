...
list( 'product_id' => $product_id ) = $args;

$product_type = get_asta_category( $product_id );
?>

<div class="wrap-input">
	<input type="text" name="price" class="input" placeholder="<?php echo __( 'Price', 'asta-child' ); ?>" value="<?php echo asta_esc_meta( $product_id, 'price' ); ?>">
...
<div class="wrap-input">
	<input type="number" name="qty" class="input" placeholder="<?php echo __( 'Quantity', 'asta-child' ); ?>" value="<?php echo asta_esc_meta( $product_id, 'qty' ); ?>">
	<span class="focus-input"></span>
	<span class="symbol-input">
...
<div class="wrap-input select">
	<select name="category" class="input">
		<option value="false"><?php echo __( 'Product type', 'asta-child' ); ?></option>
		<?php foreach ( get_asta_categories() as $key => $category ) : ?>
			<option value="<?php echo esc_html( $category->term_id ); ?>"  <?php echo ( $product_type && $product_type['id'] === $category->term_id ? 'selected' : '' ); ?>><?php echo esc_html( $category->name ); ?></option>
		<?php endforeach; ?>
	</select>
	<span class="focus-input"></span>
	<span class="symbol-input">
...
<div class="wrap-input">
	<textarea class="input aditional-info" name="aditional-info" placeholder="<?php echo __( 'Small description', 'asta-child' ); ?>"><?php echo get_post_field( 'post_excerpt', $product_id ); ?></textarea>
	<span class="focus-input"></span>
	<span class="symbol-input">
...
<?php if ( is_page_template( 'templates/edit-product.php' ) ) : ?>
	<a href="<?php echo get_permalink( $product_id ); ?>" class="btn btn-primary d-inline-flex"><?php echo __( 'Preview', 'asta-child' ); ?></a>
<?php endif; ?>