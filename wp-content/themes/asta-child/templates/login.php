...
<body>
	...
	<div class="container-fluid">
		...
		<div class="card">
			...
			<form class="login-form validate-form" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="POST">
				<span class="login-form-title"><?php echo __( 'Login', 'asta-child' ); ?></span>
				...
				<p class="login-remember"><label><input name="rememberme" type="checkbox" id="rememberme" value="forever"><?php echo __( 'Remember Me', 'asta-child' ); ?></label></p>

				<div class="container-login-form-btn">
					<button class="btn btn-primary w-100 login-form-btn"><?php echo __( 'Login', 'asta-child' ); ?></button>
				</div>

				<div class="forgot-credentials">
					<span class="label"><?php echo __( 'Forgot', 'asta-child' ); ?></span>
					<a class="link" href="#"><?php echo __( 'Username / Password?', 'asta-child' ); ?></a>
				</div>

				<div class="new-user">
					<a class="link" href="<?php echo site_url( '/register' ); ?>">
						<?php echo __( 'Create your Account', 'asta-child' ); ?>
