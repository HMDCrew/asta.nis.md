		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-4 sidebar">
					...
					<div class="wrap-input">
						<input type="text" name="price" class="input" placeholder="<?php echo __( 'Auction baze price', 'asta-child' ); ?>" value="<?php echo apply_filters( 'wpr_esc_auction_meta', $auction_id, 'baze_price' ); ?>">
						<span class="focus-input"></span>
						<span class="symbol-input">
