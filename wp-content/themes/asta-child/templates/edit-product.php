...
redirect_not_author( $product_id );
			...
			<div class="row">
				...
				<div class="col-4 sidebar">
					...
					<div class="wrap-input">
						<input type="text" name="price" class="input" placeholder="<?php echo __( 'Price', 'asta-child' ); ?>" value="<?php echo esc_auction_meta( $product_id, 'price' ); ?>">
