...
list(
	...
	'date'           => $date,
	'pay_label'      => $pay_label,
	'pay_now_label'  => $pay_now_label,
) = $args;

// implementare le subscription
?>

<div class="item-container" order_id="<?php echo $order_id; ?>">
	<div class="order-item">

		<div class="order-title">

			<h2 class="entry-title">
				<a href="<?php echo $oreder_link; ?>" rel="bookmark"><?php echo $title; ?></a>
			</h2>
		...
		<?php if ( 'paid' !== $payment_status ) : ?>
			<button type="button" class="btn btn-primary pay-now-order"><?php echo $pay_now_label; ?></button>
		<?php endif; ?>
	</div>
	...
	<?php if ( 'paid' !== $payment_status ) : ?>
		<form class="payment-form d-none">
			...
			<button id="submit" class="btn btn-primary"><?php echo $pay_label; ?></button>
		</form>
	<?php endif; ?>
</div>
